...
import com.example.summerschoolapp.repositories.NewRequestRepository;
...
public class CreateNewRequestViewModel extends BaseViewModel {
    ...
    private NewRequestRepository requestRepository;

    public CreateNewRequestViewModel(@NonNull Application application) {
        super(application);
        requestRepository = new NewRequestRepository();
    }
